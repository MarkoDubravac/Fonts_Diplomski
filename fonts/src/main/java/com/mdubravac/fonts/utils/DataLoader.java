...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        textCollection.setFonts(
                List.of(
                        new Font("Arial", TypeFaces.SANS_SERIF),
                        new Font("Times", TypeFaces.SERIF),
                        new Font("Andale Mono", TypeFaces.MONOSPACE),
                        new Font("Comic Sans MS", TypeFaces.CURSIVE),
                        new Font("Impact", TypeFaces.FANTASY)
                )
        );
        ...
        for (String text : surveyTexts) {
            ...
            surveyText.setLocalId(surveyTextRepository.countByCollectionId(textCollection.getId()) + 1);
